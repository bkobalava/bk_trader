...
console.log(buyPrice, jOld, jLast, jCurr, trend.toFixed(2), currdatetime, 'BUY!');
...
fs.appendFile('./bk_trader/register.txt',buyPrice + "\t" + jOld + "\t" + jLast + "\t" + jCurr + "\t" + trend.toFixed(2) + "\t" + currdatetime + "\t" + 'BUY!' + "\n",function(err){
	if(err)
	console.error(err);
	// console.log('Appended!');
});
...
console.log(sellPrice, jOld, jLast, jCurr, trend.toFixed(2), currdatetime, profit.toFixed(2), "%, SELL!");
...
fs.appendFile('./bk_trader/register.txt',sellPrice + "\t" + jOld + "\t" + jLast + "\t" + jCurr + "\t" + trend.toFixed(2) + "\t" + currdatetime + "\t" + 'SELL!' + "\t" + profit.toFixed(2)+ "% " + "(" + bank.toFixed(2) +")\n\n",function(err){
	if(err)
	console.error(err);
	// console.log('Appended!');
});
